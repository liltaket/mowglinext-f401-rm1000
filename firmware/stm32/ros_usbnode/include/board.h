...
#define BLADEMOTOR_REVERSE_COMMAND_VALUE 0x80u
...
/* PAC5223 bytes 9-10 are 0.1 W on this board. Normalize them to the
 * shared blade-status wire contract (mA) before transmission. */
...
/* RM-MB V6.1 blade inverter 24 V gate (active LOW). */
